      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          {step === 3 && (
            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="budget">Typical Budget for Dates ({currencySymbol})</Label>
                <Select
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value={`budget`}>Budget-Friendly (Under ${currencySymbol}50)</SelectItem>
                    <SelectItem value={`moderate`}>Moderate (${currencySymbol}50-${currencySymbol}150)</SelectItem>
                    <SelectItem value={`upscale`}>Upscale (${currencySymbol}150-${currencySymbol}300)</SelectItem>
                    <SelectItem value={`luxury`}>Luxury (${currencySymbol}300+)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
